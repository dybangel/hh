...
{
    public partial class Items : Fooke.Code.AdminHelper
    {
        ...
        protected void Add()
        {
            ...
            strText.Append("<span style=\"color:#F00\">请选择标签调用的模型,必选</span>");
            strText.Append("</td>");
            ...
            strText.Append("<option value=\"-1\" style=\"color:#F00\">自适应当前栏目</option>");
            strText.Append("</select>");
            strText.Append("</td>");
            strText.Append("</tr>");
            ...
            strText.Append(LabelHelper.ChannelColumns(""));
            strText.Append("</td>");
            strText.Append("</tr>");
        ...
        protected void Update() {
            ...
            strText.Append("<table width=\"99%\" border=\"0\" cellspacing=\"1\" cellpadding=\"3\" class=\"table\">");
            strText.Append("<tr class=\"change\">");
            strText.Append("<td class=\"Base\" colspan=\"4\">标签管理 >> 编辑标签 >> 通用函数</td>");
            strText.Append("</tr>");
            strText.Append("<tr class=\"hback\">");
            strText.Append("<td class=\"tips\">标签名称</td>");
            strText.Append("<td colspan=\"3\" class=\"check_box\">");
            ...
            strText.Append("<td class=\"tips\">限制条件</td>");
            strText.Append("<td class=\"singlebtn\" colspan=\"3\">");
            strText.Append("<input placeholder=\"格式 and 字段=条件,字符串用单引号,变量请使用{@变量名/}\" type=\"text\" size=\"60\" value=\"" + ParameterText + "\" class=\"inputtext\" name=\"ParameterText\" />");
            ...
            strText.Append("<tr class=\"hback\">");
            strText.Append("<td class=\"tips check_box\" valign=\"top\">标签内容</td>");
            strText.Append("<td class=\"singlebtn\" colspan=\"3\">");
