    ...
    public partial class WeChat : Fooke.Code.BaseHelper
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Start(strXml =>
            {
                ...
                DataRow thisRs = DbHelper.Connection.ExecuteFindRow("Stored_FindRechargeableLog", new Dictionary<string, object>() { { "strKey", thisKey } });
                ...
                if (thisRs["Model"].ToString() != "微信付款") { this.ErrorMessage("越权操作,本地订单甄别失败！"); Response.End(); }
                /*************************************************************************
                 * 查询微信订单是否存在
                 * ***********************************************************************/
