...
var ShowTasker = function(tasker)
{
	...
	************************************************************************************/
	...
	var FormatProcess = function(Process){
		...
		else if(Process=="3"){return "第三步";}	
		else if(Process=="4"){return "第四步";}	
	...
	************************************************************************************/
	try{
		var starContext="点击开始任务,前往app Store搜索页面，手动输入下方虚线框内关键词进行搜索";
	...
	************************************************************************************/
	if(tasker["appmodel"]!="5" && tasker["advmodel"]!="截图广告")
	{
		...
		var TryContext="下载完成后回到本页面,点击开始试玩,试玩三分钟";
		...
		strTemplate+="<div style=\"display:block;width:100%;font-size:0px;height:10px;\"></div>";
		strTemplate+="<div>";	
		strTemplate+="<input operate=\"button\" onclick=\"TryApplication()\" id=\"TryButton\" value=\"开始试玩\" type=\"button\"/>";
		strTemplate+="</div>";	
		strTemplate+="</td>";
		strTemplate+="</tr>";
	}
